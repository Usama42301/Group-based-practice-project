...
void setup() {
  ...
  Serial.begin(9600);
  WiFi.begin("Infinix hot 9 play", "haseeb12");
...
void loop() {
  ...
  client.println("<br>");
  client.println("<body style='text-align:center;''></body>");
  client.println("<h2>Group Members</h2>");
  client.println("<h2>Muhammad Usama Nadeem</h2>");
  client.println("<h2>Abdul Rafey</h2>");
  client.println("<h2>Abdul Haseeb</h2>");
